<template>
  <div class="decade">
    ...
    <div class="row">
      ...
      <div class="col-md-10">
        <h1 class="decade-header">The 30s</h1>
      </div>
      <div class="col-md-1"></div>
    </div>
    ...
    <div class="decadeReview row">
      ...
      <div class="col-md-4">
        <div class="timelineElement">
              <b-card class="timelineCard">
                <b-media>
                  <h5 class="mt-0">The 30s in Review</h5>
                  <div class="video">
                    <b-embed type="iframe" aspect="16by9" src="https://www.youtube.com/embed/8B8GV4VvHrU" allowfullscreen></b-embed>
                  </div>
                </b-media>
              </b-card>
            </div>
    ...
    <div class="decadeRouter row">
      ...
      <div class="col-md-2">
        <a href="#/decade/20s">
        <i class="fa fa-chevron-circle-left"></i> 20s </a>
